...
describe("PATCH /users/:username", () => {
  ...
  test("works: set new password if admin", async function () {
    const resp = await request(app)
      .patch(`/users/u1`)
      .send({
